package com.weshape3d.customviews.mycostomviews.nestedscrolldemowidget;
...
/**
 * Created by WESHAPE-DEV02 on 2017/10/9.
 */
...
public class NestedParentView extends FrameLayout implements NestedScrollingParent {
    ...
    public NestedParentView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
