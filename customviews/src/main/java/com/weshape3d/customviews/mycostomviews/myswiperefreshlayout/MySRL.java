package com.weshape3d.customviews.mycostomviews.myswiperefreshlayout;
 ...
 * </p>
 */
public class MySRL extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = MySRL.class.getSimpleName();
    ...
    MySRL.OnRefreshListener mListener;
     ...
     * @param attrs
     */
    public MySRL(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        Log.d("drummor","开始执行"+"dispatchTouchEvent()");
       boolean b = super.dispatchTouchEvent(ev);
        Log.d("drummor","执行结果"+b);
        return b;
    }
    @Override
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        Log.d("drummor","intercept"+ev.getAction());
        ensureTarget();
        ...
        Log.d("drummor","intercept"+mIsBeingDragged);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        Log.d("drummor","onTouchEvent"+ev.getAction());
        final int action = MotionEventCompat.getActionMasked(ev);
        int pointerIndex = -1;
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(MySRL parent, @Nullable View child);
    }
}
